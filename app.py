...
**How to use?:** Input a valid SMILES string of your molecule in the input field below and press 'Enter'. 
**Need a SMILES string?:** Use the [PubChem Sketcher](https://pubchem.ncbi.nlm.nih.gov/#input=draw&draw=true) to draw your molecule and generate its SMILES.
