...
st.set_page_config(page_title="CrippenLogP 2D Map Tool", layout="centered")

st.title("Explore Molecular Lipophilicity with Our 2D CrippenLogP Map Tool")
...
st.write("Mapping LogP contributions helps optimize molecular structures for improved ADME (absorption, distribution, metabolism, excretion) properties in drug development [Lipinski, 2004](https://doi.org/10.1016/S1359-6446(03)02671-2).")

st.header("How to Use")
st.write("Input a valid SMILES string of your molecule in the input field below and press 'Enter.' Need a SMILES string? Use the [PubChem Sketcher](https://pubchem.ncbi.nlm.nih.gov/#input=draw) to draw your molecule and generate its SMILES.")

st.header("Analyzing Results")
st.write("The static map color-codes atoms by LogP contribution (positive: hydrophobic, negative: hydrophilic). Review the legend for value ranges. Identify key structural features influencing lipophilicity to guide molecular design.")
