...
**Why it matters:**  
Mapping LogP contributions helps optimize molecular structures for improved ADME (absorption, distribution, metabolism, excretion) properties in drug development.  
...
This tool calculates hydrophobicity — a critical factor in drug solubility, membrane permeability, and bioavailability.

**How to use:**  
Enter a valid **SMILES** string of your molecule in the input field below and press **Enter**.  
Need a SMILES string? Use the [PubChem Sketcher](https://pubchem.ncbi.nlm.nih.gov/#input=draw&draw=true) to draw and convert your molecule.

**Analyzing results:**  
The static map color-codes atoms by LogP contribution:  
